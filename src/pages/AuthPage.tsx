  ...
  return (
    <div className="min-h-screen flex bg-[#0F0F0F]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 max-w-md px-12 space-y-6">
          ...
          <p className="text-[#8892a4] text-lg leading-relaxed">
            OKRs, roadmaps, sprints e backlog — tudo em um só lugar para
            equipes de produto que querem resultados.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div
          className="w-full max-w-[420px] space-y-8 opacity-0 animate-fade-slide-up"
        >
          {/* Logo */}
              ...
              {isLogin && (
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <label
                      htmlFor="remember"
                      className="text-sm text-[#8892a4] cursor-pointer select-none"
                    >
                      Lembrar de mim
                    </label>
                  </div>
          ...
          <p className="text-center text-sm text-[#8892a4]">
            ...
            <button
              ...
              className="text-[#4F8EF7] hover:text-[#6ba3ff] font-medium transition-colors"
            >
