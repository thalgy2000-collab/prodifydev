...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mobile: bottom sheet (full width, slides up from bottom, max 90vh).
        ...
        "inset-x-0 bottom-0 w-full max-h-[90vh] overflow-y-auto rounded-t-2xl border-b-0 p-5 pb-[calc(env(safe-area-inset-bottom)+1.25rem)] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
        // Desktop (sm+): centered modal as before.
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:max-h-none sm:overflow-visible sm:w-full sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:border-b sm:p-6 sm:pb-6 sm:data-[state=closed]:zoom-out-95 sm:data-[state=open]:zoom-in-95 sm:data-[state=closed]:slide-out-to-left-1/2 sm:data-[state=closed]:slide-out-to-top-[48%] sm:data-[state=open]:slide-in-from-left-1/2 sm:data-[state=open]:slide-in-from-top-[48%] sm:data-[state=closed]:slide-out-to-bottom-0 sm:data-[state=open]:slide-in-from-bottom-0",
        className,
      )}
      {...props}
    >
